...
def location_find():
    try:
        print("[+] Lütfen yeni bir konsolda ngrok servisini başlattıktan sonra 'ENTER' basınız.")
        asdwe = input("Devam ? ....")
        time.sleep(2)
        print("[+] Ngrok algılandı.")
        time.sleep(2)
        for i in range(1,100):
            time.sleep(0.3)
            system("figlet NRB")
            print("[+] Location Find Stating .")
            system("clear")
            time.sleep(0.3)
            system("figlet NRB")
            print("[+] Location Find Stating ..")
        ...
        print("Başlatıldı")
        time.sleep(1)
        system("xterm -e python3 seeker.py")
...
def wifi_search():
    try:
        ...
        sleep(3)
        system("xterm -e airodump-ng wlan0mon")
    except:
